...
python3 Optimisation.py -i 1000 -p 8 -e 99 -n 'Mekong_Grid' -s 'no_nuclear' -f 'modelled_baseline'
python3 Optimisation.py -i 1000 -p 8 -e 99 -n 'Mekong_Grid' -s 'no_nuclear' -f 'modelled_newbuild'

python3 Optimisation.py -i 1000 -p 8 -e 99 -n 'Mekong_Grid' -s 'no_nuclear' -f 'flexible'
python3 Optimisation.py -i 1000 -p 8 -e 99 -n 'KH' -s 'no_nuclear' -f 'flexible'
python3 Optimisation.py -i 1000 -p 8 -e 99 -n 'TH' -s 'no_nuclear' -f 'flexible'
python3 Optimisation.py -i 1000 -p 8 -e 99 -n 'Laos_Iso_Grid' -s 'no_nuclear' -f 'flexible'
python3 Optimisation.py -i 1000 -p 8 -e 99 -n 'Vietnam_Iso_Grid' -s 'no_nuclear' -f 'flexible'
